...
<head>
    ...
    <title>Data Pegawai - Honda AHASS 904</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="button-group">
            <a href="pegawaitambah.php">Tambah Pegawai</a>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a class="edit" href="pegawaiubah.php?id_pegawai=<?php echo $data['id_pegawai']; ?>">Edit</a>
                        |
                        <a class="hapus" href="pegawaihapus.php?id_pegawai=<?php echo $data['id_pegawai']; ?>" onclick="return confirm('Yakin hapus?')">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
