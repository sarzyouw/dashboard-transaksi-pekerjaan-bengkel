...
<head>
    ...
    <title>Data Motor - Honda AHASS 904</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="button-group">
            <a href="motortambah.php">Tambah Motor</a>
        ...
        <table>
            ...
            $query = mysqli_query($conn, "SELECT * FROM motor LIMIT $start, $limit");
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a class="edit" href="motorubah.php?no_polisi=<?php echo $data['no_polisi']; ?>">Edit</a>
                        |
                        <a class="hapus" href="motorhapus.php?no_polisi=<?php echo $data['no_polisi']; ?>" onclick="return confirm('Yakin hapus?')">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
