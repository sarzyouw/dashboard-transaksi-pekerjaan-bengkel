...
<head>
    ...
    <title>Customer - Honda AHASS 904</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="button-group">
            <a href="customertambah.php">Tambah Pelanggan</a>
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a class="edit" href="customerubah.php?id_customer=<?php echo $data['id_customer']; ?>">Edit</a>
                        |
                        <a class="hapus" href="customerhapus.php?id_customer=<?php echo $data['id_customer']; ?>" onclick="return confirm('Yakin hapus?')">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
